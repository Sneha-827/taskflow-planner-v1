...
export default function App() {
  ...
  return (
    <div className={cn("min-h-screen flex text-slate-900 bg-white transition-colors duration-300", settings.fontFamily)}>
      {/* Sidebar */}
      <aside className="w-20 md:w-64 bg-white border-r border-slate-200 flex flex-col p-4 md:p-6 fixed h-full z-20 transition-colors duration-300">
      ...
      {/* Main Content */}
      <main className="flex-1 ml-20 md:ml-64 p-6 md:p-10 lg:p-16">
          ...
          <div className="flex justify-end mb-10 gap-4">
            <div className="relative">
              <button 
                ...
                className="w-11 h-11 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-500 hover:bg-slate-50 transition-colors relative"
              >
                <Bell size={20} />
            ...
            <button 
              ...
              className="px-6 py-2.5 bg-black text-white rounded-xl font-semibold shadow-lg shadow-black/30 hover:bg-slate-800 hover:-translate-y-0.5 transition-all flex items-center gap-2"
            >
              <Plus size={20} />
              <span>New Task</span>
            </button>
            ...
            >
              {activeTab === 'dashboard' && (
                <Dashboard 
                  ...
                  onAddNew={() => { setEditingTask(null); setIsModalOpen(true); }}
                />
              )}
